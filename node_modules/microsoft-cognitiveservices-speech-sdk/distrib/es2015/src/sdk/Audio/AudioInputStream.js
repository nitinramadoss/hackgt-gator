...
export class PushAudioInputStreamImpl extends PushAudioInputStream {
    ...
    get blob() {
        return this.attach("id").onSuccessContinueWithPromise((audioNode) => {
            const data = [];
            let bufferData = Buffer.from("");
            const readCycle = () => {
                return audioNode.read().onSuccessContinueWithPromise((audioStreamChunk) => {
